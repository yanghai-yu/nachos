...
public class SynchList {
	...
	/**
	 * Add a series of objects to the end of the queue. If another thread is
	 * waiting in <tt>removeFirst()</tt>, it is woken up.
	 *
	 * @param objs the objects to add. Unlike the above function,it can be <tt>null</tt> or empty.
	 */
	...
	/**
	 * get next item and remove it without blocking the current thread if this SynchList is empty.
	 *
	 * @return the element removed from the front of the queue(may be null).
	 */
	public Object pop() {
		Object object;
